...
class CommunityFriendsController extends CommunityBaseController
{
			...
			<div id="addFriendContainer">
				<form name="addfriend" id="addfriend" method="post" action="">
					...
					<div class="input-wrap">
						<p>
							<textarea class="textarea" name="msg" style="width: 100%"><?php echo JText::_('COM_COMMUNITY_PROFILE_ADD_FRIEND_DEFAULT'); ?></textarea>
						</p>
					</div>
	...
	public function mutualFriends()
	{
		...
		$viewType		= $document->getType();
		$tagsFriends	= $jinput->get->get('tags','','NONE'); //JRequest::getVar( 'tags','','GET');
