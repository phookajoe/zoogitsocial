...
class CEventHelper
{
	...
	static public function getDateSelection($startDate='', $endDate='')
	{
		...
		if($config->get('eventshowampm'))
		{
			...
			$startAmPmSelect	= JHTML::_('select.genericlist',  $amPmSelect , 'starttime-ampm', array('class'=>'required'), 'value', 'text', $startAmPm , false );
			$endAmPmSelect		= JHTML::_('select.genericlist',  $amPmSelect , 'endtime-ampm', array('class'=>'required'), 'value', 'text', $endAmPm , false );
		...
		$startHourSelect		= JHTML::_('select.genericlist',  $hours, 'starttime-hour', array('class'=>'required'), 'value', 'text', $selectedStartHour , false );
		$endHourSelect			= JHTML::_('select.genericlist',  $hours, 'endtime-hour', array('class'=>'required'), 'value', 'text', $selectedEndHour , false );
		...
		$startMinSelect		= JHTML::_('select.genericlist',  $minutes , 'starttime-min', array('class'=>'required'), 'value', 'text', $startDate->Format('i') , false );
		$endMinSelect		= JHTML::_('select.genericlist',  $minutes , 'endtime-min', array('class'=>'required'), 'value', 'text', $endDate->Format('i' ) , false );
