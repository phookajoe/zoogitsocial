...
if(typeof(tags)=="string"){tags=eval("("+tags+")");}var singleTag=false;if(!joms.jQuery.isArray(tags)){tags=[tags];singleTag=true;}var newPhotoTextTags=new Array();
var a=1;if(joms.jQuery(".photoTextTags").children().length>0){joms.jQuery(".photoTextTags .photoTextTag .photoTextTagActions").append(", ");}joms.jQuery.each(tags,function(i,tag){if(tag.id==undefined){return;
}var photoTextTag=joms.jQuery('<span class="photoTextTag"></span>');photoTextTag.data("tag",tag).attr("id","photoTextTag-"+tag.id).hover(function(){joms.gallery.showPhotoTag(tag.id,"Force");
